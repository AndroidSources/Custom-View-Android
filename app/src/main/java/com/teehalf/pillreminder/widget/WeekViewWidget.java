 ...
 */
public class WeekViewWidget extends View {
    ...
    private List<WeekViewEntry> menuEntries = new ArrayList<WeekViewEntry>();

    //There is a center circle in the radial menu widget
    private WeekViewEntry centerCircle = null;
    ...
    private WeekViewEntry wedge2Data = null;


    //Radius of inner ring size
    private int MinSize = scalePX(55);
    ...
    private int MinIconSize = scalePX(3);
    //Max Size of Image in Wedge
    private int MaxIconSize = scalePX(6);
    //Inner Circle Radius
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (state == MotionEvent.ACTION_DOWN) {
            ...
            //---------The center circle onclick is being clicked here-----------------------

            if (inCircle == true) {

                Toast.makeText(getContext(), "Center circle is being clicked", Toast.LENGTH_SHORT).show();
                if (Wedge2Shown) {
                    enabled = null;
...
//            }
    ...
    public boolean addMenuEntry(WeekViewEntry entry) {
        menuEntries.add(entry);
        determineWedges();
        return true;
    }

    public boolean setCenterCircle(WeekViewEntry entry) {
        centerCircle = entry;
        return true;
    }
